...
var data = decodeUplink(payload.asBytes(), 3).data;


const measurementValue = data.messages[0][0].measurementValue;

device.endpoints.byAddress("1").updateGenericSensorStatus(measurementValue);
